...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.conv1 = nn.Conv3d(2, 64, kernel_size=5, stride=2, padding=3,
                               bias=False)
        ...
        self.avgpool = nn.AvgPool3d(1, stride=1)
...
class DANNet_source(nn.Module):

    def __init__(self, num_classes=31):
        super(DANNet_source, self).__init__()
        self.sharedNet = resnet50(False)
